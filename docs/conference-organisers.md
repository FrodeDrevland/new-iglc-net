# Guide for conference organisers and chairs
...
into your conference's collection. Give every picture a short description ("alt text") of what it
shows, for readers who cannot see it; leave it empty only for decoration.

## What comes from the IGLC
...
The IGLC freezes the website: it stays online as the record of the conference and links to its
proceedings, and it can no longer be changed.

## Help

Write to the IGLC's webmaster. Say which conference and page it is about, and what you tried.
