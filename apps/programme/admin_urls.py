...
urlpatterns = [
    ...
    path("<int:number>/build/", views.build, name="build"),
    path("<int:number>/build/programme.xlsx", views.spreadsheet, name="spreadsheet"),
    path("<int:number>/contributions/", views.contributions, name="contributions"),
